  ...
  !function(__e, __g, undefined) {
    ...
    (function(modules) {
      ...
      var $def = __webpack_require__(12),
          ...
          ENDS_WITH = 'endsWith',
          $endsWith = ''[ENDS_WITH];
      $def($def.P + $def.F * __webpack_require__(100)(ENDS_WITH), 'String', {endsWith: function endsWith(searchString) {
      ...
      var $def = __webpack_require__(12),
          context = __webpack_require__(98),
          INCLUDES = 'includes';
      $def($def.P + $def.F * __webpack_require__(100)(INCLUDES), 'String', {includes: function includes(searchString) {
          return !!~context(this, searchString, INCLUDES).indexOf(searchString, arguments[1]);
        }});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(12);
      $def($def.P, 'String', {repeat: __webpack_require__(103)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var toInteger = __webpack_require__(25),
          defined = __webpack_require__(23);
      ...
      $def($def.P + $def.F * __webpack_require__(100)(STARTS_WITH), 'String', {startsWith: function startsWith(searchString) {
      ...
      var $ = __webpack_require__(2),
          IteratorPrototype = {};
      __webpack_require__(14)(IteratorPrototype, __webpack_require__(27)('iterator'), function() {
        return this;
      });
      ...
      $def($def.S + $def.F * !__webpack_require__(113)(function(iter) {
        Array.from(iter);
      ...
      module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
        ...
        if (typeof C != 'function' || !(IS_WEAK || proto.forEach && !__webpack_require__(4)(function() {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(113)(function(iter) {
            new C(iter);
          })) {
