  ...
  !function(__e, __g, undefined) {
    ...
    (function(modules) {
      ...
      module.exports = function(name) {
        return store[name] || (store[name] = Symbol && Symbol[name] || (Symbol || __webpack_require__(26))('Symbol.' + name));
      };
    }, function(module, exports, __webpack_require__) {
      var global = __webpack_require__(7),
      ...
      var $def = __webpack_require__(12);
      $def($def.S, 'Object', {is: __webpack_require__(42)});
    }, function(module, exports) {
      ...
      var $def = __webpack_require__(12),
          ...
          ENDS_WITH = 'endsWith',
          $endsWith = ''[ENDS_WITH];
      $def($def.P + $def.F * __webpack_require__(96)(ENDS_WITH), 'String', {endsWith: function endsWith(searchString) {
      ...
      var $def = __webpack_require__(12),
          context = __webpack_require__(94),
          INCLUDES = 'includes';
      $def($def.P + $def.F * __webpack_require__(96)(INCLUDES), 'String', {includes: function includes(searchString) {
          return !!~context(this, searchString, INCLUDES).indexOf(searchString, arguments[1]);
        }});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(12);
      $def($def.P, 'String', {repeat: __webpack_require__(99)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var toInteger = __webpack_require__(22),
          defined = __webpack_require__(20);
      ...
      $def($def.P + $def.F * __webpack_require__(96)(STARTS_WITH), 'String', {startsWith: function startsWith(searchString) {
      ...
      var $ = __webpack_require__(2),
          IteratorPrototype = {};
      __webpack_require__(33)(IteratorPrototype, __webpack_require__(24)('iterator'), function() {
        return this;
      });
      ...
      $def($def.S + $def.F * !__webpack_require__(110)(function(iter) {
        Array.from(iter);
      ...
      module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
        var Base = __webpack_require__(7)[NAME],
            ...
            proto = C && C.prototype,
            O = {};
        if (!__webpack_require__(3) || typeof C != 'function' || !(IS_WEAK || proto.forEach && !__webpack_require__(4)(function() {
          new C().entries().next();
        }))) {
